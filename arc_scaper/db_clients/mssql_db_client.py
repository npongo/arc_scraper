...
class SqlServerClient(DBClient):
    ...
    def __init__(self, db_conn, sql_generator_options={}, sql_generator_templates={}):
        ...
        self._sql_generator_templates = {
            ...
            "create_spatial_index": "CREATE SPATIAL INDEX [spidx_{schema}_{name}_{idx_fields}] ON {schema}.{table_name}({idx_fields_quote}) USING GEOMETRY_AUTO_GRID  WITH (BOUNDING_BOX = (xmin = {xmin},  ymin = {ymin},  xmax = {xmax},  ymax = {ymax})); ",
