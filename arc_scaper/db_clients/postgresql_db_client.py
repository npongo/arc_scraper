...
class PostgreSQLClient(DBClient):
    ...
    def __init__(self, db_conn, sql_generator_options={}, sql_generator_templates={}):
        ...
        self._sql_generator_templates = {
            ...
            "create_spatial_index": 'CREATE INDEX "spidx_{schema}_{name}_{idx_fields}" ON "{schema}"."{table_name}" USING GIST({idx_fields_quote})',
            ...
            "create_error_table": 'CREATE SCHEMA IF NOT EXISTS arc;\n\nDROP TABLE IF EXISTS arc.errors;\n\nCREATE TABLE arc.errors(id SERIAL PRIMARY KEY, "error_message" varchar NULL, "error_type" varchar(128) NULL, "line_no" int NULL, "file_name" varchar(512) NULL)',
